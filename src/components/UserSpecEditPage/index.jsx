    ...
    <>
      ...
      >
        <div className='bg-white lg:pl-12 lg:pr-12 p-5 rounded-2xl shadow-md mt-3 w-full lg:w-1/2'>
          <h2 className="text-3xl font-bold text-[#407BFF]">Edit profile</h2>
          <p className="text-md font-medium mb-4 text-[#407BFF]">Kindly enter your correct details </p>
          <form>
            <div className="mb-2">
            ...
            <div className="mb-2">
              <Link to='/changeSaved' className='cursor-pointer'>
                <button type="button"
...
export default UserSpecEditPage;
