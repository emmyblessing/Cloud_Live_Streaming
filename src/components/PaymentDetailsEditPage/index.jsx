            ...
            <div className="mt-2 space-y-2">
              <label htmlFor="Option1" className="flex cursor-pointer gap-2">
                ...
                <div>
                  ...
                  <i className='bg-blue-200 rounded-md font-bold px-1 py-0.5 text-xs text-[#407BFF]'>Standard</i>
                  <p className='text-[#407BFF] font-bold'>R378/Year</p>
                </div>
              </label>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-[#407BFF]">R31.4</h2>
              ...
              <form>
                ...
                <div>
                  <div className='flex justify-between mt-1'>
                    <div>
                      <p className='text-[#407BFF]'>Plan fee</p>
                    </div>
                    <div>
                      <p className='text-[#407BFF] font-semibold'>R378.00</p>
                    </div>
                  </div>
                  ...
                  <div className='flex justify-between mt-1'>
                    ...
                    <div>
                      <p className='text-[#407BFF] font-semibold'>R398.00</p>
                    </div>
                  </div>
                </div>
                ...
                <div className='flex mt-4'>
                  <div className="mb-2 mr-3 w-full">
                    <Link to='/paymentEdit' className='cursor-pointer'>
                      <button type="button"
                  ...
                  <div className="mb-2 w-full">
                    <Link to='/paymentSuccess' className='cursor-pointer'>
                      <button type="button"
...
export default PaymentDetailsEditPage;
