    ...
    <>
      ...
      >
        <div className='bg-white lg:pl-12 lg:pr-12 p-5 rounded-2xl shadow-md w-full lg:w-1/2'>
          <h2 className="text-3xl font-bold text-[#407BFF]">Change Bill Plan</h2>
          <p className='text-[#407BFF]'>Enter correct details.</p>
          ...
          <div className='border-2 mt-3 border-[#407BFF] flex justify-between rounded-xl p-3'>
            ...
            <div>
              <h2 className="text-2xl font-bold text-[#407BFF]">R31.5</h2>
              ...
              <form>
                ...
                <div className='flex mt-4'>
                  ...
                  <div className="mb-2 w-full">
                    <Link to='/paymentDetailsEdit' className='cursor-pointer'>
                      <button type="button"
