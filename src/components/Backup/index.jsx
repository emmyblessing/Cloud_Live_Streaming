...
const Backup = () => {
  return (
    <>
      ...
      >
        <div className='bg-white lg:pl-12 lg:pr-12 p-5 rounded-2xl shadow-md w-full lg:w-full text-center'>
          <h2 className="text-3xl mt-3 font-bold text-[#407BFF]">Backup Data</h2>
          <p className='text-[#407BFF] mb-2'>Click the backup button to saved all your data. </p>
          <div className='flex'>
            ...
            <div className="mb-2 w-full">
              <Link to='/backupCompleted' className='cursor-pointer'>
                <button type="button"
