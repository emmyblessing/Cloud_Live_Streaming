...
import BgOtp from '../../assets/img/bg-otp.png';
  ...
  return (
    <>
      <div 
        ...
        style={{backgroundImage: `url(${BgOtp})`}}
      >
        <div className='bg-[#407BFF]/[.2] lg:pl-12 lg:pr-12 p-5 rounded-2xl shadow-md w-full lg:w-1/2'>
          <h1 className="text-3xl font-bold mb-4 text-white">Verify Phone Number</h1>
          <h2 className="text-2xl font-semibold mb-4 text-white">To verify your Phone Number, we have sent 
          an OTP to you. Kindly enter the OTP</h2>
          <form>
