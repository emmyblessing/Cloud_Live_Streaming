    ...
    <>
      ...
      >
        <div className='bg-white lg:pl-12 lg:pr-12 p-5 rounded-2xl shadow-md w-full lg:w-1/2 text-center'>
          <h2 className="text-3xl mt-3 font-bold text-[#407BFF]">Footage Requested</h2>
          <p className='text-[#407BFF] mb-2'>Footage requested successfully.</p>
          <div className="mb-2">
